...
public extension Gradient {
    ...
    static func glossy(_ color: UIColor, intensity: CGFloat = 0.5) -> Gradient {
        ...
        let colors = [
            UIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 0.95 * i),
            UIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 0.75 * i),
            UIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 0.50 * i),
            UIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 0.25 * i),
            UIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 0.10 * i),
            UIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 0.05 * i),
